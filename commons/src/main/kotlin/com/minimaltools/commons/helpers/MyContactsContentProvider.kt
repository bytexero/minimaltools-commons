package com.minimaltools.commons.helpers
...
import com.minimaltools.commons.extensions.getIntValue
import com.minimaltools.commons.extensions.getStringValue
import com.minimaltools.commons.models.PhoneNumber
import com.minimaltools.commons.models.SimpleContact
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.minimaltools.commons.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.minimaltools.dialer" && packageName != "com.minimaltools.smsmessenger" && packageName != "com.minimaltools.calendar.pro") {
                return contacts
            }
