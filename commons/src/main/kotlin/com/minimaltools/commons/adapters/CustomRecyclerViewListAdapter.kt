package com.minimaltools.commons.adapters
...
import com.minimaltools.commons.interfaces.MyActionModeCallback
import com.minimaltools.commons.models.RecyclerSelectionPayload
import com.minimaltools.commons.views.CustomRecyclerView
...
abstract class CustomRecyclerViewListAdapter<T>(
    ...
    val onRefresh: () -> Unit = {}
) : ListAdapter<T, CustomRecyclerViewListAdapter<T>.ViewHolder>(diffUtil) {
    ...
    fun setupZoomListener(zoomListener: CustomRecyclerView.MyZoomListener?) {
