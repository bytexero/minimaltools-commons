...
import com.minimaltools.commons.databinding.ActivityCustomizationBinding
import com.minimaltools.commons.dialogs.*
import com.minimaltools.commons.extensions.*
import com.minimaltools.commons.helpers.*
import com.minimaltools.commons.models.CustomTheme
...
class CustomizationActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        isThankYou = packageName.removeSuffix(".debug") == "com.minimaltools.thankyou"
        initColorVariables()
    ...
    private fun getAutoThemeColors(): CustomTheme {
    ...
    private fun getSystemThemeColors(): CustomTheme {
        return CustomTheme(
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.minimaltools.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
