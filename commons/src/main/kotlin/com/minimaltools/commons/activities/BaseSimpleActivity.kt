...
import com.minimaltools.commons.asynctasks.CopyMoveTask
import com.minimaltools.commons.compose.extensions.DEVELOPER_PLAY_STORE_URL
import com.minimaltools.commons.dialogs.*
import com.minimaltools.commons.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.minimaltools.commons.extensions.*
import com.minimaltools.commons.helpers.*
import com.minimaltools.commons.interfaces.CopyMoveListener
...
abstract class BaseSimpleActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (!packageName.startsWith("com.minimaltools.", true)) {
            if ((0..50).random() == 10 || baseConfig.appRunCount % 100 == 0) {
                val label = "You are using a fake version of the app. For your own safety download the original one from www.minimaltools.com. Thanks"
    ...
    fun handleSAFDialog(path: String, callback: (success: Boolean) -> Unit): Boolean {
        hideKeyboard()
        return if (!packageName.startsWith("com.minimaltools")) {
            callback(true)
            false
    ...
    private fun getExportSettingsFilename(): String {
        val appName = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.minimaltools.")
