...
import com.minimaltools.commons.compose.extensions.rateStarsRedirectAndThankYou
import com.minimaltools.commons.compose.screens.*
import com.minimaltools.commons.compose.theme.AppThemeSurface
import com.minimaltools.commons.dialogs.ConfirmationAdvancedAlertDialog
import com.minimaltools.commons.dialogs.RateStarsAlertDialog
import com.minimaltools.commons.extensions.*
...
class AboutActivity : ComponentActivity() {
    ...
    private fun launchFAQActivity() {
        ...
        Intent(applicationContext, com.minimaltools.commons.activities.FAQActivity::class.java).apply {
    ...
    private fun launchEmailIntent() {
        ...
        val address = if (packageName.startsWith("com.minimaltools")) {
    ...
    private fun onContributorsClick() {
        val intent = Intent(applicationContext, com.minimaltools.commons.activities.ContributorsActivity::class.java)
    ...
    private fun onFacebookClick() {
        var link = "https://www.facebook.com/minimaltools"
        try {
    ...
    private fun onGithubClick() {
        launchViewIntent("https://github.com/minimaltools")
    }

    private fun onRedditClick() {
        launchViewIntent("https://www.reddit.com/r/minimaltools")
    }


    private fun onTelegramClick() {
        launchViewIntent("https://t.me/MinimalTools")
    }


    private fun onWebsiteClick() {
        launchViewIntent("https://minimaltools.com/")
    }

    private fun onPrivacyPolicyClick() {
        val appId = baseConfig.appId.removeSuffix(".debug").removeSuffix(".pro").removePrefix("com.minimaltools.")
        val url = "https://minimaltools.com/privacy/$appId.txt"
        launchViewIntent(url)
    }

    private fun onLicenseClick() {
        Intent(applicationContext, com.minimaltools.commons.activities.MinimalLicenseActivity::class.java).apply {
            putExtra(APP_ICON_IDS, intent.getIntegerArrayListExtra(APP_ICON_IDS) ?: ArrayList<String>())
            putExtra(APP_LAUNCHER_NAME, intent.getStringExtra(APP_LAUNCHER_NAME) ?: "")
    ...
    private fun onVersionClick() {
        if (firstVersionClickTS == 0L) {
            ...
            }, com.minimaltools.commons.activities.AboutActivity.Companion.EASTER_EGG_TIME_LIMIT)
        }

        clicksSinceFirstClick++
        if (clicksSinceFirstClick >= com.minimaltools.commons.activities.AboutActivity.Companion.EASTER_EGG_REQUIRED_CLICKS) {
