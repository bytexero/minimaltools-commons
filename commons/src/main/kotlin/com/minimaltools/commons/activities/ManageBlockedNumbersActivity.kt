...
import com.minimaltools.commons.compose.extensions.onEventValue
import com.minimaltools.commons.compose.screens.ManageBlockedNumbersScreen
import com.minimaltools.commons.compose.theme.AppThemeSurface
import com.minimaltools.commons.dialogs.AddOrEditBlockedNumberAlertDialog
import com.minimaltools.commons.dialogs.ExportBlockedNumbersDialog
import com.minimaltools.commons.dialogs.FilePickerDialog
...
import com.minimaltools.commons.helpers.APP_ICON_IDS
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.minimaltools.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.minimaltools.dialer")) {
