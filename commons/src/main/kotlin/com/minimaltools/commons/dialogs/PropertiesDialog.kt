package com.minimaltools.commons.dialogs
...
import com.minimaltools.commons.activities.BaseSimpleActivity
...
import com.minimaltools.commons.views.CustomTextView
import java.io.File
import java.util.*
...
class PropertiesDialog : BasePropertiesDialog {
    ...
    private fun addProperties(path: String) {
        ...
        ensureBackgroundThread {
            ...
            this.mActivity.runOnUiThread {
                (mDialogView.propertiesHolder.findViewById<LinearLayout>(R.id.properties_size).findViewById<CustomTextView>(R.id.property_value)).text = size

                if (fileDirItem.isDirectory) {
                    (mDialogView.propertiesHolder.findViewById<LinearLayout>(R.id.properties_file_count).findViewById<CustomTextView>(R.id.property_value)).text = fileCount.toString()
                    (mDialogView.propertiesHolder.findViewById<LinearLayout>(R.id.properties_direct_children_count).findViewById<CustomTextView>(R.id.property_value)).text =
        ...
        if (fileDirItem.isDirectory) {
            ...
            if (mActivity.baseConfig.appId.removeSuffix(".debug") == "com.minimaltools.filemanager.pro") {
                ...
                ensureBackgroundThread {
                    ...
                    mActivity.runOnUiThread {
                        if (md5 != null) {
                            (mDialogView.propertiesHolder.findViewById<LinearLayout>(R.id.properties_md5).findViewById<CustomTextView>(R.id.property_value)).text = md5
                        } else {
    ...
    private fun updateLastModified(activity: Activity, view: View, timestamp: Long) {
        activity.runOnUiThread {
            (view.findViewById<LinearLayout>(R.id.properties_last_modified).findViewById<CustomTextView>(R.id.property_value)).text = timestamp.formatDate(activity)
        }
    }
