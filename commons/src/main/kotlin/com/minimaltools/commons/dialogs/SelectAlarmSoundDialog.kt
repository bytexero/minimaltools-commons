...
import com.minimaltools.commons.databinding.DialogSelectAlarmSoundBinding
import com.minimaltools.commons.extensions.*
import com.minimaltools.commons.helpers.SILENT
import com.minimaltools.commons.models.AlarmSound
import com.minimaltools.commons.models.RadioItem
import com.minimaltools.commons.views.CustomCompatRadioButton
...
class SelectAlarmSoundDialog(
    ...
    private fun addAlarmSound(alarmSound: AlarmSound, holder: ViewGroup) {
        val radioButton = (activity.layoutInflater.inflate(R.layout.item_select_alarm_sound, null) as CustomCompatRadioButton).apply {
