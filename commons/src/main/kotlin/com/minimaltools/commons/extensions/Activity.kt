...
import com.minimaltools.commons.databinding.DialogTitleBinding
...
import com.minimaltools.commons.models.*
...
fun Activity.launchPurchaseThankYouIntent() {
    hideKeyboard()
    try {
        launchViewIntent("market://details?id=com.minimaltools.thankyou")
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.minimaltools.gallery.pro" || applicationId == "com.minimaltools.gallery.pro.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null) {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.minimaltools.dialer.debug" else "com.minimaltools.dialer"
                val className = "com.minimaltools.dialer.activities.DialerActivity"
