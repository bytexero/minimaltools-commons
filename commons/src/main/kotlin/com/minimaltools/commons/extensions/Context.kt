...
import com.minimaltools.commons.models.AlarmSound
import com.minimaltools.commons.models.BlockedNumber
import com.minimaltools.commons.helpers.PREFS_KEY
import java.io.File
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.minimaltools.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isThankYouInstalled() = isPackageInstalled("com.minimaltools.thankyou")
...
fun Context.isAProApp() = packageName.startsWith("com.minimaltools.") && packageName.removeSuffix(".debug").endsWith(".pro")
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.minimaltools."))
...
fun Context.isDefaultDialer(): Boolean {
    return if (!packageName.startsWith("com.minimaltools.contacts") && !packageName.startsWith("com.minimaltools.dialer")) {
        true
    } else if ((packageName.startsWith("com.minimaltools.contacts") || packageName.startsWith("com.minimaltools.dialer")) && isQPlus()) {
